...
>
    ...
    <x-sidebarButton route='thread.index' :params="['filter' => 'all']" :mood="$mood" icon='forum' label='Thread' content="Be part of the discussion!"></x-sidebarButton>
    <x-sidebarButton route="social.index" :params="['filter' => 'all']" :mood="$mood" icon='social' label='Social' content="Connect with others now!"></x-sidebarButton>
