    ...
    <div class="font-primary bg-shadedOfGray-10 min-h-screen text-shadedOfGray-85">
        <div class="min-h-screen flex flex-col justify-center items-center py-12 sm:px-6 lg:px-8">
            <div class="sm:mx-auto sm:w-full sm:max-w-md mb-6">
                <h2 class="text-center text-title font-bold text-primary-100">
                    Buat Playlist Baru
                </h2>
            </div>
            ...
            <div class="sm:mx-auto sm:w-full sm:max-w-md">
                <div class="bg-white py-8 px-4 shadow rounded-lg sm:px-10 border border-shadedOfGray-20">
                    <form action="{{ route('admin.playlists.store') }}" method="POST" class="space-y-6">
                        @csrf
                        <div>
                        ...
                        <div class="flex items-center justify-end space-x-4 pt-4">
                            ...
                            <button type="submit" class="flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-mediumBtn font-medium text-white bg-primary-85 hover:bg-primary-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-50 font-secondaryAndButton">
                                Simpan Playlist
                            </button>
                        </div>
                    </form>
