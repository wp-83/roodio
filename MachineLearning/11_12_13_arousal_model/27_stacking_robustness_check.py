...
FOLDS = 5
SEED = 43 # Seed yang sama agar perbandingan fair

print(f"🚀 MEMULAI EXP 27: STACKING ENSEMBLE (WITH STABILITY CHECK)...")
...
std_acc = np.std(acc_scores) * 100  # <--- HITUNG DEVIAZI STANDAR
...
plt.savefig('cm_exp27_robustness.png')
plt.show()
...
import joblib
# clf_audio adalah Random Forest, meta_clf adalah Logistic Regression
joblib.dump(clf_audio, 'models/stage2a_rf.pkl')
joblib.dump(meta_clf, 'models/stage2a_meta.pkl')
print("💾 Model Stage 2A berhasil disimpan!")