...
<div class='w-full h-full'>
    ...
    <div {{ $attributes->merge(["class" => 'flex flex-col justify-center items-center gap-5 w-8 h-8 bg-secondary-happy-20 rounded-full relative ' . $backgroundHover[$mood] . ' ']) }} >
    ...
    <div class='flex flex-col items-center justify-center gap-1.5 py-1 w-max h-max  group relative '>
        <div class='bg-secondary-sad-100 w-8 h-1 rounded-md group-hover:w-10 group-hover:scale-y-50 duration-350 transition-all group-hover:opacity-60'></div>
        <div class='bg-secondary-sad-100 w-8 h-1 rounded-md group-hover:w-10 group-hover:scale-y-50 duration-350 transition-all group-hover:opacity-60'></div>
        <div class='bg-secondary-sad-100 w-8 h-1 rounded-md group-hover:w-10 group-hover:scale-y-50 duration-350 transition-all group-hover:opacity-60'></div>
        <div class='absolute top-1/2 left-1/8 w-5 h-5 -translate-y-1/2'>
