...
@section('bodyContent')
    ...
    <div class='flex flex-col flex-1 min-h-0'>
        <div class='flex flex-row flex-1 min-h-0 relative'>
            ...
            <div id='scrollContainer' class='w-full bg-primary-100 overflow-x-hidden overflow-y-auto min-h-0 p-10 scrollbar scrollbar-thumb-primary-60 scrollbar-track-shadedOfGray-10 @yield('mainContentContainerClass')'>
                @yield('mainContent')
            </div>
        </div>
    </div>
