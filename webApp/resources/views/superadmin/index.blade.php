...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6 mb-8">
        ...
        <div class="relative overflow-hidden bg-gradient-to-br from-primary-85 to-primary-100 p-6 rounded-2xl shadow-lg border border-primary-70 flex items-center justify-between group">
            <div class="relative z-10">
                <p class="text-sm text-[#9CA3AF] mb-1 font-secondaryAndButton font-bold uppercase tracking-wider">New Registrations</p>
    ...
    <div class="bg-primary-85 rounded-2xl shadow-lg border border-primary-70 overflow-visible">
        ...
        <div class="p-4 lg:p-6 border-b border-primary-70 flex flex-col md:flex-row md:items-center justify-between gap-4 bg-primary-85/50 backdrop-blur-sm rounded-t-2xl">
            ...
            <form action="{{ route('superadmin.users.index') }}" method="GET" class="w-full md:w-80 lg:w-96">
                ...
                <div class="relative w-full group">
                    <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-[#9CA3AF] group-focus-within:text-secondary-happy-100 transition-colors pointer-events-none">
                        <i class="fa-solid fa-magnifying-glass"></i>
                    </span>
                    <input type="text" name="search" value="{{ request('search') }}" placeholder="Search by username..."
                        class="w-full pl-10 pr-10 py-2.5 lg:py-3 rounded-xl border border-primary-60 bg-primary-100 text-white focus:outline-none focus:border-secondary-happy-100 focus:ring-1 focus:ring-secondary-happy-100 text-sm transition-all shadow-md placeholder-[#9CA3AF]">

                    @if(request()->filled('search'))
                        <a href="{{ route('superadmin.users.index', request()->except(['search', 'page'])) }}" class="absolute inset-y-0 right-0 pr-3 flex items-center text-[#9CA3AF] hover:text-white cursor-pointer transition-colors" title="Clear Search">
                            <i class="fa-solid fa-xmark"></i>
                        </a>
                    @endif
                ...
                <div class="relative flex-1 md:flex-none">
                    ...
                    <div id="filterPopup" class="hidden absolute top-full right-0 mt-2 w-48 bg-primary-85 rounded-xl shadow-2xl border border-primary-70 z-50 overflow-hidden">
                        <div class="px-4 py-3 border-b border-primary-70 bg-primary-70/30">
                            <p class="text-xs font-bold text-[#9CA3AF] uppercase tracking-wider">Filter by Role</p>
                        </div>
                        ...
                        @if(request()->has('role'))
                            <div class="border-t border-primary-70">
                                <a href="{{ route('superadmin.users.index') }}" class="block px-4 py-3 text-xs text-center text-[#9CA3AF] hover:text-white font-bold transition-colors bg-primary-70/20">Reset Filter</a>
                            </div>
                        @endif
                    </div>
                </div>
                ...
                <tbody class="divide-y divide-primary-70 text-sm">
                    @foreach($users as $user)
                        <tr class="hover:bg-primary-70/30 transition-colors duration-150 group">
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-[#9CA3AF]"><span>@</span>{{ $user->username }}</p>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4 text-[#9CA3AF] font-mono text-xs">{{ $user->created_at->format('d M Y') }}</td>
        ...
        <div class="p-4 lg:p-6 border-t border-primary-70 flex flex-col sm:flex-row items-center justify-between gap-4 bg-primary-85/50 rounded-b-2xl">
            <p class="text-sm text-[#9CA3AF] text-center sm:text-left">
    ...
    <div id="createUserModal" class="hidden fixed inset-0 lg:left-72 lg:top-20 z-50 flex items-center justify-center transition-all duration-300">
        ...
        <div class="relative bg-primary-85 rounded-2xl shadow-2xl border border-primary-70 w-full max-w-3xl m-4 flex flex-col max-h-[90%]">
            ...
            <div class="px-6 py-4 border-b border-primary-70 flex justify-between items-center bg-primary-85 rounded-t-2xl shrink-0">
                ...
                <button onclick="toggleCreateModal()" class="text-[#9CA3AF] hover:text-white transition-colors">
                ...
                <form id="createUserForm" action="{{ route('superadmin.users.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="relative">
                                <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-[#9CA3AF]"><i class="fa-solid fa-at"></i></span>
                                <input type="text" name="username" maxlength="25" placeholder="e.g. johndoe" value="{{ old('username') }}"
                                    class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-primary-60 bg-primary-100 text-white focus:border-secondary-happy-100 focus:ring-1 focus:ring-secondary-happy-100 text-sm transition-colors placeholder-[#9CA3AF]">
                            </div>
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="relative">
                                <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-[#9CA3AF]"><i class="fa-regular fa-envelope"></i></span>
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="relative">
                                <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-[#9CA3AF]"><i class="fa-solid fa-lock"></i></span>
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="relative">
                                <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-[#9CA3AF]"><i class="fa-solid fa-shield-halved"></i></span>
                                ...
                                <span class="absolute inset-y-0 right-0 pr-3 flex items-center text-[#9CA3AF] pointer-events-none"><i class="fa-solid fa-chevron-down text-xs"></i></span>
                            </div>
                        ...
                        <div class="space-y-1 md:col-span-2">
                            ...
                            <input type="text" name="fullname" maxlength="255" placeholder="e.g. Johnathan Doe" value="{{ old('fullname') }}"
                                class="w-full px-4 py-2.5 rounded-xl border border-primary-60 bg-primary-100 text-white focus:border-secondary-happy-100 focus:ring-1 focus:ring-secondary-happy-100 text-sm transition-colors placeholder-[#9CA3AF]">
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="relative">
                                ...
                                <span class="absolute inset-y-0 right-0 pr-3 flex items-center text-[#9CA3AF] pointer-events-none">
                        ...
                        <div class="space-y-1">
                            ...
                            <input type="file" name="profilePhoto" accept="image/*"
                                class="w-full text-sm text-[#9CA3AF] file:mr-4 file:py-2.5 file:px-4 file:rounded-xl file:border-0 file:text-sm file:font-bold file:bg-primary-60 file:text-white hover:file:bg-primary-50 cursor-pointer border border-primary-60 rounded-xl bg-primary-100">
                    ...
                    <div class="mt-8 flex items-center justify-end gap-3 pt-6 border-t border-primary-70">
                        <button type="button" onclick="toggleCreateModal()" class="px-6 py-2.5 rounded-xl border border-primary-60 text-[#9CA3AF] font-bold hover:bg-primary-70 hover:text-white transition-colors text-sm">Cancel</button>
    ...
    <div id="editUserModal" class="hidden fixed inset-0 lg:left-72 lg:top-20 z-50 flex items-center justify-center transition-all duration-300">
        ...
        <div class="relative bg-primary-85 rounded-2xl shadow-2xl border border-primary-70 w-full max-w-3xl m-4 flex flex-col max-h-[90%]">
            ...
            <div class="px-6 py-4 border-b border-primary-70 flex justify-between items-center bg-primary-85 rounded-t-2xl shrink-0">
                ...
                <button onclick="toggleEditModal()" class="text-[#9CA3AF] hover:text-white transition-colors">
                    <i class="fa-solid fa-xmark text-xl"></i>
                </button>
            </div>
            ...
            <div class="overflow-y-auto p-6 lg:p-8 custom-scrollbar">
                <form id="editUserForm" action="#" method="POST" enctype="multipart/form-data">
                    ...
                    {{-- Footer --}}
                    <div class="mt-8 flex items-center justify-end gap-3 pt-6 border-t border-primary-70">
                        <button type="button" onclick="toggleEditModal()" class="px-6 py-2.5 rounded-xl border border-primary-60 text-[#9CA3AF] font-bold hover:bg-primary-70 hover:text-white transition-colors text-sm">Cancel</button>
            ...
            <div class="p-6">
                ...
                <form id="deleteUserForm" action="#" method="POST">
                    ...
                    <div class="flex items-center justify-end gap-3 mt-6 pt-4 border-t border-primary-70">
                        <button type="button" onclick="toggleDeleteModal()" class="px-5 py-2.5 rounded-xl border border-primary-60 text-[#9CA3AF] font-bold hover:bg-primary-70 hover:text-white transition-colors text-sm">Cancel</button>
