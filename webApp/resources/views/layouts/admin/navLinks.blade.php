<nav class="flex-1 px-4 space-y-1 overflow-y-auto py-4">
    ...
    <p class="px-4 text-micro font-bold text-primary-20 uppercase tracking-wider mb-2 mt-2">Menu</p>
    ...
    <p class="px-4 text-micro font-bold text-primary-20 uppercase tracking-wider mb-2 mt-6">Library</p>
